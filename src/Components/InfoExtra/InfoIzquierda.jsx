  ...
  <div className="card-container">
    <div className="card-content">
      <div className="card-title">
        <span className="title">Personales</span>
      </div>
      <div className="card-body">
        <span className="title">"Cada idea tiene su historia. Juntos la convertimos en una página web."</span>
      </div>
      <div className="card-footer">
        <span className="title">¡Lo hacemos posible!</span>
      </div>
    </div>
  </div>
</section>
